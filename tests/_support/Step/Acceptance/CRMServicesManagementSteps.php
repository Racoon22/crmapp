...
class CRMServicesManagementSteps extends CRMGuestSteps
{
    ...
    function imagineService()
    {
        ...
        return [
            'ServicesRecord[name]' => $faker->sentence($words = 3),
            'ServicesRecord[hourly_rate]' => $faker->randomNumber($digits = 2),
        ];
    }
    ...
    {
        $I = $this;
        $I->see($service_data['ServicesRecord[name]'], self::SERVICES_LIST_SELECTOR);
    }
    ...
    {
        $I = $this;
        $I->dontSee($service_data['ServicesRecord[name]'],
    ...
    public function seeEditButtonBesideService($service_data)
    {
        ...
        $xpath = $this->makeXpathForButtonNearServiceName(
            $service_data['ServicesRecord[name]'],
            'Update'
        );
        $I->seeElement($xpath);
    }
